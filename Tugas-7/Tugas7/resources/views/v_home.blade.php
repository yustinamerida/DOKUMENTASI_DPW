   ...
   <!-- Bagian BANNER -->
    <section class="banner" id="banner">
        <div class="content">
            ...
            <p>TOKO BUNGA KETAPANG | FLORIST KETAPANG LENGKAP DAN MURAH</p>
                <a href="clientproduk" class="btn">ALL PRODUK</a>
                <a href="v_login" class="btn">REGISTER</a>
    ...
    <section class="menu" id="menu">
        ...
        <div class="content">
            ...
            <div class="tittle">
                <a href="clientproduk" class="btn">TAMPILKAN SEMUA</a>
            </div>
        </div>
    </section>
